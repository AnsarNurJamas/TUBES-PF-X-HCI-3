        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('transaction.index')}}" class="nav-item nav-link active"><i class="fa fa-user me-2"></i>Penjualan</a>
        ...
        <div class="content">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <div class="ms-4 mt-4">
                    <ul class="list-inline mb-0 float-end">
                        ...
                        <li class="list-inline-item ">
                            <a href="{{ route('transaction.create', AppHelper::transaction_code())}}" class="me-4 btn btn-success">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="bg-secondary justify-content-between rounded p-4">
                        <table class="table text-start align-middle table-bordered table-hover mb-0 datatable" id="TransactionTable">
                            <thead>
                                <tr class="text-white">
