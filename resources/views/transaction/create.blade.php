        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('transaction.create', AppHelper::transaction_code())}}" class="nav-item nav-link active"><i class="fa fa-cash-register me-2"></i>Transaksi Baru</a>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right">
                                            <div class="btn-group" role="group">
                                                <button class="btn btn-success btn-icon icon-left" data-toggle="modal" data-target="">
                ...
                <div class="row mt-3">
                    <div class="col-lg-3">
                        <form action="{{route('transaction.store')}}" method="post">
                            ...
                            <div class="bg-secondary card" style="height: 270px">
                    ...
                    <div class="col-lg">
                        <div class="card bg-secondary" style="height: 275px">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-2">
                                                    <input type="text" name="discount" class="form-control bg-dark" value="" readonly>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" name="discount_price" class="form-control currency bg-dark" value="" readonly />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" name="grand_total" class="form-control currency bg-dark" value="{{ $subTotal }}" readonly />
                                                </div>
                                            </div>
                                        </div>
